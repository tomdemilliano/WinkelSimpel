...
export const CentralCategoryFactory = {
  ...
  create: async ({ name, iconUrl = '', color = '#4CAF50', approvedBy, sourceOrgId, sourceCategoryId }) =>
...
export const CentralProductFactory = {
  ...
  create: async ({ name, imageUrl, unit, approvedBy, sourceOrgId, sourceProductId, centralCategoryId = null }) =>
