...
export const ProductFactory = {
  ...
  create: async (orgId, { name, imageUrl, unit = 'stuks', categoryId = null, centralProductId = null, createdBy }) => {
    const data = {
      name,
      imageUrl,
      unit,
...
export const ListItemFactory = {
   ...
   * Snapshots the product name, image and category at the time of creation,
   * so the list remains correct even if the product is later edited.
   */
  create: async (orgId, listId, { productId, productName, productImageUrl, categoryId = null, categoryName = null, categoryIconUrl = null, quantity, order }) => {
    return addDoc(
      collection(db, 'organizations', orgId, 'shoppingLists', listId, 'items'),
      {
        productId,
